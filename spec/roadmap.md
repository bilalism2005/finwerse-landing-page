...
- **Spec'd, not yet built:** Home screen (`spec/ui.md` → "Screen: Home"), Stock Detail screen (`spec/ui.md` → "Screen: Stock Detail"), and the new More screen (`spec/ui.md` → "Screen: More"), plus the 5-tab nav shell restructuring.
