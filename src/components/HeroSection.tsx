...
const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center hero-grid pt-20">
      <div className="max-w-7xl mx-auto px-10 w-full grid md:grid-cols-2 gap-12 items-center" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
        {/* Phone Mockup */}
        ...
        <div className="flex flex-col gap-6">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bebas uppercase leading-[0.95] tracking-wide text-foreground">
