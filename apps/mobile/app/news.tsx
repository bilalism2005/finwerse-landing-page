...
function createStyles(tokens: ThemeTokens) {
  return StyleSheet.create({
    ...
    sourceText: { fontSize: 13, color: tokens.textTertiary, fontWeight: '500', flexShrink: 1 },
    dateText: { fontSize: 13, color: tokens.textTertiary },
    errorBox: {
      padding: 20,
      backgroundColor: tokens.elevatedSurface,
      borderRadius: 14,
    ...
    errorText: { color: tokens.negative, fontSize: 15, marginBottom: 8, textAlign: 'center' },
